const main = {
     ...
     * @param {Object} params
     */
    drawBlock({ text, width = 0, height, x, y, paddingLeft = 0, paddingRight = 0, borderWidth, backgroundColor, borderColor, borderRadius = 0, opacity = 1 , boxSetShadow}) {
        // 判断是否块内有文字
        ...
        if (backgroundColor) {
            ...
            if(boxSetShadow){
                this.ctx.setShadow(boxSetShadow.a,boxSetShadow.b,boxSetShadow.c, boxSetShadow.d);
            };
            if (borderRadius > 0) {
                // 画圆角矩形
