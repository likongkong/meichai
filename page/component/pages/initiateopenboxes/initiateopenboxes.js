...
Page({
  ...
  ispaysharefun:function(){
    this.setData({
      ispayshare:false
    })
  },
  ispaysharedis: function () {
    this.setData({
      ispayshare: true
    })
  },
  ...
  onShareAppMessage: function(options) {
    ...
    var share = {
      ...
      path: "/page/component/pages/initiateopenboxes/initiateopenboxes?gid=" + _this.data.gid + '&referee=' + _this.data.uid + '&id=' + _this.data.id,
      success: function(res) {}
    }
    return share;
  },
