...
Page({
  ...
  onLoad: function(options) {
    ...
    if (options.scene) {
      ...
      _this.data.specialsource = _this.getSearchString('specialsource', scene) || 0;
    } else {
      app.signindata.referee = options.referee || 0;
      _this.data.specialsource = options.specialsource || 0;
    }
  ...
  onLoadfun: function() {
    var _this = this;
    _this.data.myComponent = this.selectComponent('#myComponent'); // 页面获取自定义组件实例
    _this.data.loginid = app.signindata.loginid;
    _this.data.openid = app.signindata.openid;
    _this.setData({
      uid: app.signindata.uid,
  ...
  getInfo: function() {
    var _this = this;
    var q1 = Dec.Aese('mod=automat&operation=getInfo'+'&uid='+_this.data.uid+'&loginid='+_this.data.loginid+'&specialSource='+_this.data.specialsource);
  ...
  getRecord: function(pid) {
    ...
    var q1 = Dec.Aese('mod=automat&operation=getRecord' + '&pid=' + pid+'&specialSource='+_this.data.specialsource);
  ...
  onShareAppMessage: function() {
    ...
    var _this = this
    var share = {
      title: "PicoPico五一免费抽盲盒！",
      path: '/page/component/pages/doubleElevenexh/doubleElevenexh?specialsource=2',
      imageUrl: "http://cdn.51chaidan.com/images/background/picoTurn.png",
      success: function(res) {
  ...
  gotosmokebox: function() {
    var _this = this;
    _this.data.myComponent.wnews(); // 通过实例调用组件事件
  },
  ...
  clickgetAward: function() {
    ...
    var q1 = Dec.Aese('mod=automat&operation=draw' + '&uid=' + _this.data.uid + '&loginid=' + _this.data.loginid + "&aid=" + _this.data.aid+'&specialSource='+_this.data.specialsource);
      ...
      success: function(res) {
        ...
        if (res.data.ReturnCode == 200) {
          _this.setData({
            ...
            luckyvalue:res.data.Info.role.luckyValue,
            luckyimg:res.data.Info.role.roleImg,
  ...
  againroll: function() {
    ...
    var q1 = Dec.Aese('mod=automat&operation=reroll' + '&uid=' + _this.data.uid + '&loginid=' + _this.data.loginid + "&oid=" + _this.data.oid+'&specialSource='+_this.data.specialsource);
  ...
  mswiperRequest: function(num) {
    ...
    //   mpid: 0,
    //   bpid: 0,
    var q = Dec.Aese('mod=automat&operation=getBoxImg&type=1&pid=' + _this.data.mpid+'&specialSource='+_this.data.specialsource);
    wx.request({
  ...
  bswiperRequest: function(num) {
    ...
    var q = Dec.Aese('mod=automat&operation=getBoxImg&type=0&pid=' + _this.data.bpid+'&specialSource='+_this.data.specialsource);
    wx.request({
      url: app.signindata.comurl + 'spread.php' + q,
      method: 'GET',
      header: {
