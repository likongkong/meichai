...
Page({
  ...
  dateFun(){
    var nowTime = new Date().getTime();
    // var nowTime = '1623517200000';
    var time11 = '1623427200000';
    var time12 = '1623513600000';
    var time13 = '1623600000000';
    var time14 = '1623686400000';
    ...
    if(nowTime>time14){
      ...
      if(nowTime >= time12 && nowTime <= time13){
        console.log(2)
        this.data.objectArray[0].disabled = true;
        this.setData({num:5})
