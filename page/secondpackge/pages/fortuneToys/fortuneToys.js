...
Page({
  ...
  getAward(){
    ...
    var q = Dec.Aese('mod=LuckyDraw&operation=getCashOnly&uid=' + _this.data.uid + '&loginid=' + _this.data.loginid)
    console.log('mod=LuckyDraw&operation=getCashOnly&uid=' + _this.data.uid + '&loginid=' + _this.data.loginid)
    wx.request({
